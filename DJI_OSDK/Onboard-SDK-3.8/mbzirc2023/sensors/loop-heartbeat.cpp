...
/****************************************
*
*   Start the timer so heartbeats are provided
*
*****************************************/
...
/***********************************************
*
*   Returns the current value of the heartbeat and
*   sets the internal beat value to 0 (resets)
*
***********************************************/
...
/****************************************
*
*   Stops the time and closes the thread
*
*****************************************/
...
/****************************************
*
*   Sets a new frequency for the timer
*
*****************************************/
void HeartbeatTimer::set_freq(int freq)
{
    beat_length = (int) (1.0 / ( (float) freq) * 10000.0);
}
...
/*******************************************
*
*   The heartbeat main loop. Calculates when
*   the timeout time is reached and then sets the flag high
*   Its important to have a usleep ellers it 100% blocks a CPU core
*
**********************************************/
void HeartbeatTimer::heartbeat_timer()
{
