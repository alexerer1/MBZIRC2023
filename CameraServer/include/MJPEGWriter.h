// Credits to : https://github.com/JPery/MJPEGWriter
#include <unistd.h>
#include <sys/time.h>
#include <sys/types.h>
...
public:
    ...
    void start(){
        ...
        if( pthread_setname_np( thread_listen, "MJPEG listen") != 0) std::cout << "namefail\n";
        pthread_create(&thread_write, NULL, this->writer_Helper, this);
        if( pthread_setname_np( thread_write, "MJPEG write") != 0) std::cout << "namefail\n";
    }
